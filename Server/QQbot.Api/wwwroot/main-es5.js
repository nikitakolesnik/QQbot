    ...
    function () {
      ...
      _createClass(AppComponent, [{
        ...
        value: function ngOnInit() {
          ...
          var count = 1; //this.addToLobby({ name: 'Holye',     pos: count++, role: null, pref: ['w', 'd', 'a', 'p', 'r', 'e', 'n', 'me', 'prot', 'heal', 'rt'] });
        ...
        key: "setRole",
        value: function setRole(player, role, team) {
        ...
        value: function removeFromLobby(player) {
          this.removeFromList(player, this.lobby); //this.setLobbyPlayerNumbers();
        ...
        key: "team1Clear",
        value: function team1Clear() {
          if (this.team1.length == 0) return;
        ...
        key: "team2Clear",
        value: function team2Clear() {
          if (this.team2.length == 0) return;
        ...
        key: "team1Win",
        value: function team1Win() {
          if (this.team1.length == 8 && this.team2.length == 8) this.addMessage('You recorded a win for Team 1.');
        }
      }, {
        key: "team2Win",
        value: function team2Win() {
          if (this.team1.length == 8 && this.team2.length == 8) this.addMessage('You recorded a win for Team 2.');
        }
      }]);
