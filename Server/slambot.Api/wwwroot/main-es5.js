...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
    ...
    function () {
      ...
      _createClass(AppComponent, [{
        ...
        value: function addMessage(msg) {
          if (this.history.length >= 22) this.history.pop();
          this.history.unshift('[' + new Date().toLocaleTimeString() + '] ' + msg);
        } // LOBBY

      }, {
        key: "numberLobby",
        value: function numberLobby() {
        ...
        key: "addToLobby",
        value: function addToLobby(player) {
          player.team = 0;
        ...
        key: "setTeam",
        value: function setTeam(player, team) {
        ...
        key: "setNoTeam",
        value: function setNoTeam(player) {
        ...
        key: "teamClear",
        value: function teamClear(team) {
          this.teamCount[team] = 0;
          this.lobby.forEach(function (player) {
            if (player.team == team) player.team = 0;
          });
        ...
        key: "teamWin",
        value: function teamWin(team) {
          if (this.teamCount[1] == 8 && this.teamCount[2] == 8) this.addMessage('You recorded a win for Team ' + team + '.');
        }
      }]);
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _teampipe__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! ./teampipe */
    "./src/app/teampipe.ts");
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
      declarations: [_app_component__WEBPACK_IMPORTED_MODULE_4__["AppComponent"], _teampipe__WEBPACK_IMPORTED_MODULE_5__["TeamPipe"]],
  ...
  /*! exports provided: TeamPipe */

  /***/
  function srcAppTeampipeTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "TeamPipe", function () {
      return TeamPipe;
    });
    /* harmony import */
    ...
    function () {
      function TeamPipe() {
        _classCallCheck(this, TeamPipe);
      }

      _createClass(TeamPipe, [{
        key: "transform",
        value: function transform(items, team) {
          if (!items) {
            return items;
          }
    ...
    TeamPipe = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Pipe"])({
      name: 'teamfilter',
      pure: false
    })], TeamPipe);
    /***/
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! C:\Users\nikit\source\repos\Projects\QQbot\WebClient\src\main.ts */
    "./src/main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
